...
var TechnicalExport = /** @class */ (function (_super) {
    ...
    TechnicalExport.prototype.invoke = function (terminal) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        saveContent = TerminalStringer.toString(terminal);
                        navigator.clipboard.writeText(saveContent);
                        return [4 /*yield*/, terminal.addLines(new TerminalLine('Saved technical terminal contents to clipboard.'))];
                    case 1:
                        _a.sent();
                        terminal.openInput();
                        return [2 /*return*/];
